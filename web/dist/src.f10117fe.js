...
function () {
  ...
  Model.prototype.save = function () {
    ...
    this.sync.save(this.attributes.getAll()).then(function (ressponse) {
      _this.trigger('save');
    }).catch(function () {
      _this.trigger('error');
    });
...
function (_super) {
  ...
  User.buildUser = function (atttrs) {
    return new User(new Attributes_1.Attributes(atttrs), new Eventing_1.Eventing(), new ApiSync_1.ApiSync(rootUrl));
  };
...
exports.User = User;
},{"./Model":"src/models/Model.ts","./ApiSync":"src/models/ApiSync.ts","./Eventing":"src/models/Eventing.ts","./Attributes":"src/models/Attributes.ts","./Collection":"src/models/Collection.ts"}],"src/views/CollectionView.ts":[function(require,module,exports) {
"use strict";
